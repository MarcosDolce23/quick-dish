    ...
    render() {
        return (
            <div className="fridge-container">
                {this.props.ingredients.sort((a, b) => a.name.localeCompare(b.name)).map((item, i) => {
                    return (
                                        ...
                                        <div key={"C1" + i} className="light">
                                            <label>
                                                ...
                                                <input
                                                    ...
                                                    onChange={() => this.props.onChange(ingredient)}
                                                    checked={this.props.value.includes(ingredient)}
                                                ></input>
